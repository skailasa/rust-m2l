...
pub fn hadamard_product_kernel_neon(a_ra: float64x2_t, b_ra: float64x2_t) -> float64x2_t {
    unsafe {
        ...
        // let real = vmlsq_f64(vget_low_f64(real_mul), vget_high_f64(a_imag), vget_high_f64(b_ra));
        // let imag = vmlaq_f64(vget_low_f64(imag_mul), vget_high_f64(a_real), vget_high_f64(b_ra));
